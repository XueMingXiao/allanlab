...
![]({{ site.url }}{{ site.baseurl }}/images/respic/ugv.jpg){: style="width: 30%; float: right; margin: 0px"}
![]({{ site.url }}{{ site.baseurl }}/images/respic/qpp.jpg){: style="width: 30%; float: right; margin: 0px"}
